...
-- Users table (authentication, permissions, usage limits)
...
-- Conversation history captured per persona
...
-- Application wide key/value store
...
-- Default admin + realtime model seed
INSERT INTO users (username, email, password_hash, full_name, is_admin, is_active)
VALUES ('admin', 'admin@alsatalk.com', '.gJ3MxQKa.8LhYXYvG5qYp8xOBZJKC.W5lM8Qy8Dy', 'System Administrator', TRUE, TRUE)
